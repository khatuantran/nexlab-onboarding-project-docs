...
export function SearchResultRow({ hit }: SearchResultRowProps): JSX.Element {
  ...
  return (
    <Link
      ...
      className="block rounded-xl border border-border bg-card p-5 transition-all hover:border-primary/30 hover:shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
    >
      ...
      <h3 className="mt-1 font-display text-base font-semibold text-foreground">{hit.title}</h3>
      <p
