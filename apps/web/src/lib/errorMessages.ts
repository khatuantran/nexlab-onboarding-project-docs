...
const MESSAGES: Record<ErrorCode, string> = {
  ...
  USER_EMAIL_EXISTS: "Email đã được dùng cho user khác",
  USER_DISABLED: "Tài khoản đã bị vô hiệu hoá, liên hệ admin",
  CANNOT_MODIFY_SELF: "Không thể thực hiện thao tác này lên chính tài khoản của bạn",
  LAST_ADMIN_PROTECTED: "Không thể disable / demote admin cuối cùng trong hệ thống",
