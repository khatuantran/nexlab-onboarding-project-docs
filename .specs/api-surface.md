...
| GET    | `/uploads/:id`          | ❌   | —                | 200 binary + `Content-Type` (public read — UUIDv4 = token)  | 404                                                                         | FR-UPLOAD-001                                                                   | [T3 ✅ `4690b8e`](stories/US-003/tasks.md#t3--get-uploads-id-static-serve); auth dropped [BUG-003 `db94afc`](bugs/BUG-003.md) |
