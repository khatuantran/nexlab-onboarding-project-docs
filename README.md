...
🚧 **M2 in progress — US-002 Author path.** M1 complete (US-001 ✅). Progress: **T2/8 done** — POST /projects API với admin gate + 409 slug handling + shared schemas. 99 tests green (46 web + 38 api + 15 shared).
...
- [US-002 — BA creates project + feature with business sections](.specs/stories/US-002.md) + [tasks](.specs/stories/US-002/tasks.md) — in progress (T2/8 ✅)
